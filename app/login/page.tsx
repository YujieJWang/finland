  ...
  return (
    ...
    >
      <section
        ...
        style={{ width: "min(100%, 470px)", padding: "clamp(28px, 8vw, 52px)" }}
      >
        <div aria-hidden style={{ fontSize: 42, marginBottom: 22 }}>
          💌
        </div>
        ...
        <p className="muted" style={{ lineHeight: 1.7, marginBottom: 28 }}>
          Use your gmail address babe. this sends you a private way in without
        ...
        {configured ? (
          ...
          <div className="status" role="alert">
            This app is ready for its Supabase keys. Copy{" "}
            <code>.env.example</code> to <code>.env.local</code> to begin.
          </div>
        )}
      </section>
    </main>
